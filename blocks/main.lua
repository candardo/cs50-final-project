function love.load()
    ...
    -- Inert (not moving) blocks. All empty at first
    inert = {}
    ...
    -- Pieces stored as a table
    -- Every piece is a table containing a table with every possible rotation
    pieceStructures = {
        {
            {
                {' ', ' ', ' ', ' '},
    ...
    -- Timer and time interval for pieces fall
    timer = 0
    timerLimit = 0.5
